...
| **Traefik** | Traefik | Reverse proxy with HTTPS |
...
│  │ • Sonarr    │  │ • Traefik   │  │ • Grafana   │  │   Assistant│ │
│  │ • Radarr    │  │             │  │ • Loki      │  │ • Zigbee   │ │
│  │ • qBit      │  │             │  │ • Uptime    │  │ • Mealie   │ │
│  │ • Prowlarr  │  │             │  │   Kuma      │  │ • MQTT     │ │
│  │ • Jellyseerr│  │             │  │             │  │            │ │
...
✓ **Security first** - VPN for torrents, HTTPS everywhere  
...
2. **Use VPN** for torrent traffic
3. **Rotate secrets** every 6-12 months
4. **Keep services updated** - `make pull && make up-full`
5. **Regular backups** - `make backup`
6. **Monitor logs** for suspicious activity
7. **Consider adding IP restrictions** for admin services in Traefik dynamic config
